Dentro da pasta pulsar_project estão algumas funções feitas de raíz entre as quais os classificadores: 
-Linear Regression classifier
-KNN classifier 
-Rosenblat's Perceptron
-Perceptron with MinOver's Algorithm for maximum stability
...
TestFile_LR.py para a Linear Regression
TestFile_KNN.py para KNN
TestFile_DT.py para Decision Trees
TestFile_RF.py para Random Forests
TestFIle_Rosenblat.py para Rosenblat's Perceptron
TestFile_MinOver.py para Perceptron with MinOver's Algorithm for maximum stability
